...
const index: React.FC = () => {
    ...
    const Container = () => {
        ...
        return <iframe style={{ minHeight: `calc(100vh - ${headerHeight}px - 72px)`, border: 'none' }} src={`https://prod20290-125166753.442hattrick.com/ko/korean-view${addUrl}`} className="w-full h-full" />;
    };
    //取得id = header的元素高度
