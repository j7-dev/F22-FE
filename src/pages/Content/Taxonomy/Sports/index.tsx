...
const index: React.FC = () => {
    ...
    const Container = () => {
        ...
        return <iframe style={{ border: 'none' }} src={`https://prod20290-125166753.442hattrick.com/ko/korean-view${addUrl}`} className="w-full h-full" />;
    };

    return (
        <div className="sportPage sm:my-9 sm:gap-8 my-4 w-full h-screen">
