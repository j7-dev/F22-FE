...
const Evolution: React.FC = () => {
    ...
    return (
        <div className="w-full h-auto bg-[#F6F7F7] pb-20">
            ...
            <div className="w-full h-auto flex mx-auto flex-col items-center mt-[-2.5rem] mb-6 z-10 ">{/* <GameCategory Provider="evolution" /> */}</div>
                ...
                <div className="FilterGames dropdown-menu w-full flex justify-center items-center mt-10">
                    <div className="w-[1360px] flex flex-col justify-center flex-wrap gap-4  py-5 px-10 ">
                        <div className="gamesCategoryInfo w-auto text-center">
                            <h3 className="gamesCategory mb-2">IGX Golf {t('Sports')}</h3>
                            <img src={gigxProviderImg} alt="" className="m-auto h-28m-auto w-full md:w-auto object-contain my-10" />
