...
const index: React.FC<{ bankInfo?: TBankAccount }> = ({ bankInfo }) => {
    ...
    if (!bankInfo)
        return (
            <div className="h-full w-full py-[42px] userBank flex flex-col gap-4 rounded-2xl md:shadow-[0_4px_20px_0px_rgba(163,112,237,0.25)] md:px-[32px]">
    ...
    return (
        <div className="bg-white h-full w-full py-6 px-4 gap-3 userBank flex flex-col rounded-2xl md:py-[42px] md:px-[32px] md:gap-4 shadow-[0_4px_20px_0px_rgba(163,112,237,0.25)]">
            <span className="text-black font-bold md:text-2xl text-sm">{t('Bank Information')}</span>
            <div className="BankCard flex items-center justify-center w-full  flex-col relative md:h-[200px] md:aspect-[240/200] h-[90px] aspect-[130-90]">
                <div className="BankCardBg relative h-full w-full p-4 md:p-8 md:rounded-[30px] rounded-2xl bg-cover bg-no-repeat bg-center">
