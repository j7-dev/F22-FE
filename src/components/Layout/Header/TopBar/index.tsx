                        ...
                        <div className="languageSwitch flex-col justify-center w-[150px] hidden absolute bg-white rounded-xl z-10 p-2.5  my-0">
                            {languages.map((item) => {
                                ...
                                return (
                                    <li
                                        key={nanoid()}
                                        className="flex flex-row justify-center gap-2.5 items-center h-10 px-2.5 cursor-pointer rounded "
                                    >
                                        <span
                                            className={`inline-flex w-20 justify-start items-center gap-2 font-bold  hover:text-black text-sm ${
                                                currentLanguageName ===
                                                changeLanguage
                                                    ? 'text-black'
                                                    : 'text-slate-400'
