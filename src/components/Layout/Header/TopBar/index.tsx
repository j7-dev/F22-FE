    ...
    return (
        <>
            ...
            <div className="bg-[#2B3240] w-full px-4 sm:px-6 lg:px-8">
                <div className=" py-1 max-w-7xl mx-auto flex items-center justify-end gap-x-5 w-full">
                    ...
                    <div className="languageSwitchContain w-[150px] text-center">
                        ...
                        <div className="languageSwitch flex-col gap-2.5 justify-center w-[150px] hidden absolute bg-white rounded-xl z-10 p-2.5  my-0">
                            {languages
                                .filter(
                                    (item) => item.language !== i18n.language,
                                )
                                .map((item) => {
                                    ...
                                    return (
                                        <li
                                            key={nanoid()}
                                            className="flex flex-row justify-center gap-2.5 items-center h-10 px-2.5 cursor-pointer bg-[#EFEFEF] rounded "
                                        >
                                            <span
                                                className="inline-flex justify-center items-center gap-2 font-bold text-slate-400 hover:text-black text-sm "
                                                onClick={() =>
