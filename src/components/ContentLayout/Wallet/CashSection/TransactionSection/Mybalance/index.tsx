    ...
    return (
        <div className="w-full bg-white rounded-lg shadow-[0_0px_29px_0px_rgba(43, 50, 64, 0.09)] flex flex-col gap-2.5 p-4">
            <Form form={form} initialValues={{ amount: '0' }}>
                <SelectGame label={t('Select the game source of money')} itemName="sourceGame" />
                <QuickAmountInput formItemProps={{ label: t('Amount to transfer'), name: ['amount'] }} />
                <SelectGame label={t('Select the game to receive the money')} itemName="reciiveGame" />
