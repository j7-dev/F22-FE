...
import AmountInput from '@/components/ContentLayout/Wallet/CashSection/TransactionSection/Mybalance/AmountInput';
    ...
    return (
        <div className="w-full bg-white rounded-lg shadow-[0_0px_29px_0px_rgba(43, 50, 64, 0.09)] flex flex-col gap-2.5 p-4">
            ...
            <div className="BPSwichButton flex gap-1 ">
                <div
                    className={`${
                        selectedSection === 'CompBonus'
                            ? 'bg-[#F9A318] text-white'
                            : ''
