...
const Popup: React.FC = () => {
    ...
    return (
        <div className={`${popupIsOpen ? 'fixed' : 'hidden'} popupOverlay px-2 md:px-0 w-screen h-screen backdrop-blur-sm bg-[#000000d9] z-50 left-0 top-0 flex justify-center items-center`} onClick={handleOverlayClick}>
            <div ref={popupContainerRef} className="relative popupContainer w-full h-full md:m-auto md:max-w-[600px] md:min-h-[700px] md:max-h-screen rounded-[20px] bg-gradient-to-r from-[#E9AAF1] to-[#8155EC]">
                ...
                <div className="relative w-full flex flex-col justify-center items-center m-auto py-10 px-20 h-full ">
                    <div className="formWrap flex flex-nowrap overflow-x-hidden w-full">
                        <div ref={formCarouselRef} className="min-w-[200%] flex duration-300 h-full" id="formCarousel">
                            <Login />
                            <SignUp />
                        </div>
                    </div>
