...
const DoubleConfirmSwitch: React.FC<{
...
}> = ({ enabled, popconfirmProps, tooltipProps, switchProps, onClick, onConfirm, onCancel }) => {
    ...
    const confirmEnable = (e: React.MouseEvent<HTMLElement, MouseEvent> | undefined) => {
        setSwitchState({
    ...
    const cancelEnable = (e: React.MouseEvent<HTMLElement, MouseEvent> | undefined) => {
        setSwitchState({
            checked: !switchState.checked,
            popconfirmDisabled: !switchState.checked,
        });
